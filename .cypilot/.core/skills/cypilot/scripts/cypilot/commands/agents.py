...
_GENERATED_MARKER = "<!-- Generated by cypilot agents -- do not edit -->"
_GENERATED_MARKER_TOML = "# Generated by cypilot agents -- do not edit"
_GENERATED_MARKER_RE = re.compile(
    r"^<!--\s*Generated by cypilot agents\s*--\s*do not edit\s*-->\s*\n?",
    re.MULTILINE,
)
